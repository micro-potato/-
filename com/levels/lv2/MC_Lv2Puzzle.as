package com.levels.lv2 {
	...
	public class MC_Lv2Puzzle extends BasePuzzle {
		...
		override protected function Init():void 
		{
			...
			_ionTrap.SwitchOn = false;
			
			//init pwd
			var pwd1:Array = [1,1,1,1];
			var pwd2:Array = [1,0,1,0];
			var pwd3:Array = [0,1,0,1];
			var pwd4:Array = [0,1,0,0];
			_pwd = [pwd1, pwd2, pwd3, pwd4];
			_ionTrap.Password = _pwd;
			
			//init init result
			var ir1:Array = [1,0,0,0];
			var ir2:Array = [1,0,0,0];
			var ir3:Array = [1,0,0,0];
		...
		{
			var successMC:MovieClip = new MC_Pass2();
